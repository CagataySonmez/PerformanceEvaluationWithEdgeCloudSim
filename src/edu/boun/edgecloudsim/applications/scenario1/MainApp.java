...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/scenario1/config/default_config.properties";
			applicationsFile = "scripts/scenario1/config/applications.xml";
			edgeDevicesFile = "scripts/scenario1/config/edge_devices.xml";
			outputFolder = "sim_results/scenario1/ite" + iterationNumber;
		}
