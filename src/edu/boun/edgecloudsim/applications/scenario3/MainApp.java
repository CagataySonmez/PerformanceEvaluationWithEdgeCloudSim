...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/scenario3/config/default_config.properties";
			applicationsFile = "scripts/scenario3/config/applications.xml";
			edgeDevicesFile = "scripts/scenario3/config/edge_devices.xml";
			outputFolder = "sim_results/scenario3/ite" + iterationNumber;
		}
