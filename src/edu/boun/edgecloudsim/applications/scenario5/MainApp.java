...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/scenario5/config/default_config1.properties";
			applicationsFile = "scripts/scenario5/config/applications.xml";
			edgeDevicesFile = "scripts/scenario5/config/edge_devices1.xml";
			outputFolder = "sim_results/scenario5/ite" + iterationNumber;
		}
