...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/scenario2/config/default_config.properties";
			applicationsFile = "scripts/scenario2/config/applications.xml";
			edgeDevicesFile = "scripts/scenario2/config/edge_devices.xml";
			outputFolder = "sim_results/scenario2/ite" + iterationNumber;
		}
