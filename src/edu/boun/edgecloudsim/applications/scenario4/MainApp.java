...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/scenario4/config/default_config.properties";
			applicationsFile = "scripts/scenario4/config/applications.xml";
			edgeDevicesFile = "scripts/scenario4/config/edge_devices.xml";
			outputFolder = "sim_results/scenario4/ite" + iterationNumber;
		}
